(function (app) {
  ...
  function showTextPopup(ev) {
    ...
    if ($(this).attr("data-id") == "popuptext2") {
      //addSB
      console.log("-=-");
  ...
  function showTextPopup(ev) {
    console.log("--", $(this).attr("data-id"));
    if ($(this).attr("data-id") == "popuptext3") {
      //addSB
      console.log("-=-");
  ...
  function showTextPopup(ev) {
    console.log("--", $(this).attr("data-id"));
    if ($(this).attr("data-id") == "popuptext4") {
      //addSB
      console.log("-=-");
  ...
  function hideTextPopup(ev) {
    if ($(this).parent().attr("id") == "popuptext3") {
      // $("#textA12").css("height","auto");//addSB
    }
    $(this).parent().hide();
  }
  function hideTextPopup(ev) {
    if ($(this).parent().attr("id") == "popuptext4") {
      // $("#textA12").css("height","auto");//addSB
    }
    $(this).parent().hide();
  }
  ...
  function fnClickRadioBox(ev) {
    ...
    $(".rb:visible").each(function (index) {
      ...
      console.log(
        "Match>>>",
        $(currentCheckbox).parent().text(),
        "With>>>",
        $(loopCheckbox).parent().text(),
      );
      if (
        $(currentCheckbox).parent().text() != $(loopCheckbox).parent().text()
      ) {
  ...
  function init() {
    ...
    for (var i = 0; i < nCount; i++) {
      footerLi +=
        '<li><span id="navigate' + i + '" class="navigation"></span></li>';
    }
    footerLi += "</ul>";
